...
public class record {
    ...
    public void setSubFirstSign(int sign) {
        this.subFirstSign = sign;
    }

    public int getSubFirstSign() {
        return subFirstSign;
    }

    public void setSubSecondSign(int sign) {
        this.subSecondSign = sign;
    }

    public int getSubSecondSign() {
        return subSecondSign;
    }

    public void setResFirstSign(int sign) {
        this.resFirstSign = sign;
    }

    public int getResFirstSign() {
        return resFirstSign;
    }

    public void setResSecondSign(int sign) {
        this.resSecondSign = sign;
    }

    public int getResSecondSign() {
